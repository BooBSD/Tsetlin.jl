...
Achieves **37 million** MNIST predictions per second at 98% accuracy with **4.7 GB/s** throughput on a desktop CPU, while also demonstrating the first Tsetlin Machine–based **text generation** example.
